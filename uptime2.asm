...
main(int argc, char * argv[])
{
  ...
  2d:	53                   	push   %ebx
  2e:	e8 58 03 00 00       	call   38b <uptime2>
  ...
  69:	50                   	push   %eax
  6a:	50                   	push   %eax
  6b:	68 68 07 00 00       	push   $0x768
  70:	6a 01                	push   $0x1
  72:	e8 c9 03 00 00       	call   440 <printf>
    uint ut = uptime2(i);
  77:	89 1c 24             	mov    %ebx,(%esp)
  7a:	e8 0c 03 00 00       	call   38b <uptime2>
    } else if(i == 3){
...
free(void *ap)
{
 ...
 5f1:	a1 04 0b 00 00       	mov    0xb04,%eax
{
 ...
 631:	5b                   	pop    %ebx
  freep = p;
 632:	89 15 04 0b 00 00    	mov    %edx,0xb04
}
 638:	5e                   	pop    %esi
 639:	5f                   	pop    %edi
 63a:	5d                   	pop    %ebp
 ...
 667:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 66a:	89 15 04 0b 00 00    	mov    %edx,0xb04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 15 04 0b 00 00    	mov    0xb04,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cb:	39 05 04 0b 00 00    	cmp    %eax,0xb04
 ...
 6ee:	e8 fd fe ff ff       	call   5f0 <free>
  return freep;
 6f3:	8b 15 04 0b 00 00    	mov    0xb04,%edx
 ...
 71c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 71f:	89 15 04 0b 00 00    	mov    %edx,0xb04
}
 ...
 72f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 04 0b 00 00 08 	movl   $0xb08,0xb04
 737:	0b 00 00 
    base.s.size = 0;
 73a:	b8 08 0b 00 00       	mov    $0xb08,%eax
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 08 0b 00 00 08 	movl   $0xb08,0xb08
 746:	0b 00 00 
    base.s.size = 0;
 749:	c7 05 0c 0b 00 00 00 	movl   $0x0,0xb0c
 750:	00 00 00 
    if(p->s.size >= nunits){

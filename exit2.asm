 ...
 5b1:	a1 84 0a 00 00       	mov    0xa84,%eax
{
 ...
 627:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62a:	89 15 84 0a 00 00    	mov    %edx,0xa84
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 84 0a 00 00    	mov    0xa84,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68b:	39 05 84 0a 00 00    	cmp    %eax,0xa84
 ...
 6ae:	e8 fd fe ff ff       	call   5b0 <free>
  return freep;
 6b3:	8b 15 84 0a 00 00    	mov    0xa84,%edx
 ...
 6dc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6df:	89 15 84 0a 00 00    	mov    %edx,0xa84
}
 ...
 6ef:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 84 0a 00 00 88 	movl   $0xa88,0xa84
 6f7:	0a 00 00 
    base.s.size = 0;
 6fa:	b8 88 0a 00 00       	mov    $0xa88,%eax
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 88 0a 00 00 88 	movl   $0xa88,0xa88
 706:	0a 00 00 
    base.s.size = 0;
 709:	c7 05 8c 0a 00 00 00 	movl   $0x0,0xa8c
 710:	00 00 00 
    if(p->s.size >= nunits){

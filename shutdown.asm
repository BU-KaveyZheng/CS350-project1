 ...
 328:	89 d1                	mov    %edx,%ecx
{
 ...
 35b:	0f b6 92 50 07 00 00 	movzbl 0x750(%edx),%edx
 ...
 3c9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 434:	ff 24 85 f8 06 00 00 	jmp    *0x6f8(,%eax,4)
 ...
 560:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 565:	bb ee 06 00 00       	mov    $0x6ee,%ebx
...
free(void *ap)
{
 ...
 571:	a1 ec 09 00 00       	mov    0x9ec,%eax
{
 ...
 5b1:	5b                   	pop    %ebx
  freep = p;
 5b2:	89 15 ec 09 00 00    	mov    %edx,0x9ec
}
 5b8:	5e                   	pop    %esi
 5b9:	5f                   	pop    %edi
 5ba:	5d                   	pop    %ebp
 ...
 5e7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 5ea:	89 15 ec 09 00 00    	mov    %edx,0x9ec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 609:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 60c:	8b 15 ec 09 00 00    	mov    0x9ec,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 64b:	39 05 ec 09 00 00    	cmp    %eax,0x9ec
 ...
 66e:	e8 fd fe ff ff       	call   570 <free>
  return freep;
 673:	8b 15 ec 09 00 00    	mov    0x9ec,%edx
 ...
 6b7:	09 00 00 
    base.s.size = 0;
 6ba:	b8 f0 09 00 00       	mov    $0x9f0,%eax
    base.s.ptr = freep = prevp = &base;
 6bf:	c7 05 f0 09 00 00 f0 	movl   $0x9f0,0x9f0
 6c6:	09 00 00 
    base.s.size = 0;
 6c9:	c7 05 f4 09 00 00 00 	movl   $0x0,0x9f4
 6d0:	00 00 00 
    if(p->s.size >= nunits){

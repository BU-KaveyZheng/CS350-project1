...
{    
  ...
  16:	50                   	push   %eax
  17:	50                   	push   %eax
  18:	68 f8 06 00 00       	push   $0x6f8
  1d:	6a 01                	push   $0x1
  1f:	e8 ac 03 00 00       	call   3d0 <printf>
 ...
 338:	89 d1                	mov    %edx,%ecx
{
 ...
 36b:	0f b6 92 8c 07 00 00 	movzbl 0x78c(%edx),%edx
 ...
 3d9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 444:	ff 24 85 34 07 00 00 	jmp    *0x734(,%eax,4)
 ...
 570:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 575:	bb 2d 07 00 00       	mov    $0x72d,%ebx
...
free(void *ap)
{
 ...
 581:	a1 3c 0a 00 00       	mov    0xa3c,%eax
{
 ...
 5c1:	5b                   	pop    %ebx
  freep = p;
 5c2:	89 15 3c 0a 00 00    	mov    %edx,0xa3c
}
 5c8:	5e                   	pop    %esi
 5c9:	5f                   	pop    %edi
 5ca:	5d                   	pop    %ebp
 ...
 5f7:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 5fa:	89 15 3c 0a 00 00    	mov    %edx,0xa3c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 15 3c 0a 00 00    	mov    0xa3c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 65b:	39 05 3c 0a 00 00    	cmp    %eax,0xa3c
 ...
 67e:	e8 fd fe ff ff       	call   580 <free>
  return freep;
 683:	8b 15 3c 0a 00 00    	mov    0xa3c,%edx
 ...
 6ac:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6af:	89 15 3c 0a 00 00    	mov    %edx,0xa3c
}
 ...
 6bf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6c0:	c7 05 3c 0a 00 00 40 	movl   $0xa40,0xa3c
 6c7:	0a 00 00 
    base.s.size = 0;
 6ca:	b8 40 0a 00 00       	mov    $0xa40,%eax
    base.s.ptr = freep = prevp = &base;
 6cf:	c7 05 40 0a 00 00 40 	movl   $0xa40,0xa40
 6d6:	0a 00 00 
    base.s.size = 0;
 6d9:	c7 05 44 0a 00 00 00 	movl   $0x0,0xa44
 6e0:	00 00 00 
    if(p->s.size >= nunits){

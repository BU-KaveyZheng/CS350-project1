...
80100d1e:	e8 ed 63 00 00       	call   80107110 <copyout>
...
80100d8f:	e8 7c 63 00 00       	call   80107110 <copyout>
...
80102108:	68 42 79 10 80       	push   $0x80107942
...
801030a2:	e8 b9 28 00 00       	call   80105960 <idtinit>
...
801030c3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
801030c6:	e8 a5 39 00 00       	call   80106a70 <switchkvm>
  seginit();
801030cb:	e8 10 39 00 00       	call   801069e0 <seginit>
  lapicinit();
...
80103124:	e8 27 2b 00 00       	call   80105c50 <uartinit>
  pinit();         // process table
80103129:	e8 42 08 00 00       	call   80103970 <pinit>
  tvinit();        // trap vectors
8010312e:	e8 ad 27 00 00       	call   801058e0 <tvinit>
  binit();         // buffer cache
...
8010323e:	68 f8 76 10 80       	push   $0x801076f8
...
801032f9:	68 fd 76 10 80       	push   $0x801076fd
...
80103423:	68 02 77 10 80       	push   $0x80107702
...
80103452:	68 f8 76 10 80       	push   $0x801076f8
...
80103488:	68 1c 77 10 80       	push   $0x8010771c
...
80103530:	00 00 00 
  initlock(&p->lock, "pipe");
80103533:	68 3b 77 10 80       	push   $0x8010773b
...
801038c4:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
801038c7:	c7 40 14 ce 58 10 80 	movl   $0x801058ce,0x14(%eax)
  p->context = (struct context*)sp;
...
80103976:	68 40 77 10 80       	push   $0x80107740
...
80103a53:	e8 58 34 00 00       	call   80106eb0 <setupkvm>
...
80103a71:	e8 1a 31 00 00       	call   80106b90 <inituvm>
...
80103adf:	68 70 77 10 80       	push   $0x80107770
80103ae4:	50                   	push   %eax
80103ae5:	e8 c6 0d 00 00       	call   801048b0 <safestrcpy>
  p->cwd = namei("/");
80103aea:	c7 04 24 79 77 10 80 	movl   $0x80107779,(%esp)
...
80103b23:	68 57 77 10 80       	push   $0x80107757
...
80103b5b:	e8 20 2f 00 00       	call   80106a80 <switchuvm>
  return 0;
...
80103b7a:	e8 61 31 00 00       	call   80106ce0 <allocuvm>
...
80103b9a:	e8 61 32 00 00       	call   80106e00 <deallocuvm>
...
80103be8:	e8 b3 33 00 00       	call   80106fa0 <copyuvm>
...
80103d10:	e8 6b 2d 00 00       	call   80106a80 <switchuvm>
...
80103d22:	e8 e4 0b 00 00       	call   8010490b <swtch>
      switchkvm();
80103d27:	e8 44 2d 00 00       	call   80106a70 <switchkvm>
      c->proc = 0;
...
80103f3d:	68 c8 77 10 80       	push   $0x801077c8
80103f42:	e8 39 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103f47:	83 ec 0c             	sub    $0xc,%esp
80103f4a:	68 bb 77 10 80       	push   $0x801077bb
...
80104029:	e8 02 2e 00 00       	call   80106e30 <freevm>
        p->pid = 0;
...
80104080:	68 d4 77 10 80       	push   $0x801077d4
...
80104189:	68 da 77 10 80       	push   $0x801077da
8010418e:	e8 ed c1 ff ff       	call   80100380 <panic>
    panic("sleep");
80104193:	83 ec 0c             	sub    $0xc,%esp
80104196:	68 d4 77 10 80       	push   $0x801077d4
...
8010429b:	68 5b 7b 10 80       	push   $0x80107b5b
...
801042bc:	74 ea                	je     801042a8 <procdump+0x28>
      state = "???";
801042be:	ba eb 77 10 80       	mov    $0x801077eb,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801042c3:	83 f8 05             	cmp    $0x5,%eax
801042c6:	77 11                	ja     801042d9 <procdump+0x59>
801042c8:	8b 14 85 4c 78 10 80 	mov    -0x7fef87b4(,%eax,4),%edx
      state = "???";
801042cf:	b8 eb 77 10 80       	mov    $0x801077eb,%eax
...
801042de:	68 ef 77 10 80       	push   $0x801077ef
...
8010431d:	68 41 72 10 80       	push   $0x80107241
...
8010434a:	68 64 78 10 80       	push   $0x80107864
...
80104643:	68 6f 78 10 80       	push   $0x8010786f
...
80104695:	68 77 78 10 80       	push   $0x80107877
8010469a:	e8 e1 bc ff ff       	call   80100380 <panic>
    panic("popcli");
8010469f:	83 ec 0c             	sub    $0xc,%esp
801046a2:	68 8e 78 10 80       	push   $0x8010788e
...
801046c1:	68 95 78 10 80       	push   $0x80107895
...
801050bd:	58                   	pop    %eax
801050be:	5a                   	pop    %edx
801050bf:	68 38 79 10 80       	push   $0x80107938
...
801050d8:	68 37 79 10 80       	push   $0x80107937
...
8010588e:	e8 1d ee ff ff       	call   801046b0 <release>
  return xticks;
}
...
801058a0 <sys_shutdown>:
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801058a0:	b8 00 20 00 00       	mov    $0x2000,%eax
801058a5:	ba 04 b0 ff ff       	mov    $0xffffb004,%edx
801058aa:	66 ef                	out    %ax,(%dx)
801058ac:	ba 04 06 00 00       	mov    $0x604,%edx
801058b1:	66 ef                	out    %ax,(%dx)
sys_shutdown(void) 
{
...
801058b7:	06                   	push   %es
  pushl %fs
801058b8:	0f a0                	push   %fs
  pushl %gs
801058ba:	0f a8                	push   %gs
  pushal
801058bc:	60                   	pusha
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801058bd:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801058c1:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801058c3:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801058c5:	54                   	push   %esp
  call trap
801058c6:	e8 c5 00 00 00       	call   80105990 <trap>
  addl $4, %esp
801058cb:	83 c4 04             	add    $0x4,%esp
...
801058ce:	61                   	popa
  popl %gs
801058cf:	0f a9                	pop    %gs
  popl %fs
801058d1:	0f a1                	pop    %fs
  popl %es
801058d3:	07                   	pop    %es
  popl %ds
801058d4:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801058d5:	83 c4 08             	add    $0x8,%esp
  iret
801058d8:	cf                   	iret
...
801059bf:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801059c0:	e8 0b c9 ff ff       	call   801022d0 <ideintr>
    lapiceoi();
801059c5:	e8 d6 cf ff ff       	call   801029a0 <lapiceoi>
  }
...
801059ca:	e8 41 e0 ff ff       	call   80103a10 <myproc>
801059cf:	85 c0                	test   %eax,%eax
801059d1:	74 1d                	je     801059f0 <trap+0x60>
801059d3:	e8 38 e0 ff ff       	call   80103a10 <myproc>
...
801059f0:	e8 1b e0 ff ff       	call   80103a10 <myproc>
801059f5:	85 c0                	test   %eax,%eax
801059f7:	74 0f                	je     80105a08 <trap+0x78>
801059f9:	e8 12 e0 ff ff       	call   80103a10 <myproc>
...
80105a02:	0f 84 b8 00 00 00    	je     80105ac0 <trap+0x130>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a08:	e8 03 e0 ff ff       	call   80103a10 <myproc>
80105a0d:	85 c0                	test   %eax,%eax
80105a0f:	74 1d                	je     80105a2e <trap+0x9e>
80105a11:	e8 fa df ff ff       	call   80103a10 <myproc>
...
80105a40:	e8 cb df ff ff       	call   80103a10 <myproc>
...
80105a60:	e8 8b df ff ff       	call   801039f0 <cpuid>
...
80105a71:	e8 9a df ff ff       	call   80103a10 <myproc>
...
80105aa2:	e8 69 df ff ff       	call   80103a10 <myproc>
80105aa7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105aae:	e8 5d df ff ff       	call   80103a10 <myproc>
...
80105ac4:	0f 85 3e ff ff ff    	jne    80105a08 <trap+0x78>
    yield();
80105aca:	e8 c1 e5 ff ff       	call   80104090 <yield>
...
80105adf:	e8 0c df ff ff       	call   801039f0 <cpuid>
...
80105aec:	e8 bf ab ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105af1:	e8 aa ce ff ff       	call   801029a0 <lapiceoi>
    break;
...
80105b43:	5d                   	pop    %ebp
      exit();
80105b44:	e9 e7 e2 ff ff       	jmp    80103e30 <exit>
80105b49:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105b50:	e8 4b 02 00 00       	call   80105da0 <uartintr>
    lapiceoi();
80105b55:	e8 46 ce ff ff       	call   801029a0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b5a:	e8 b1 de ff ff       	call   80103a10 <myproc>
...
80105b6c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105b70:	e8 eb cc ff ff       	call   80102860 <kbdintr>
    lapiceoi();
80105b75:	e8 26 ce ff ff       	call   801029a0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
80105b8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105b90:	e8 5b de ff ff       	call   801039f0 <cpuid>
...
80105cd1:	e8 2a c8 ff ff       	call   80102500 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
80105cfd:	e8 be cc ff ff       	call   801029c0 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
...
80105d6d:	e8 4e cc ff ff       	call   801029c0 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
...
80105db7:	6a 00                	push   $0x0
  jmp alltraps
80105db9:	e9 f8 fa ff ff       	jmp    801058b6 <alltraps>
...
80105dc0:	6a 01                	push   $0x1
  jmp alltraps
80105dc2:	e9 ef fa ff ff       	jmp    801058b6 <alltraps>
...
80105dc9:	6a 02                	push   $0x2
  jmp alltraps
80105dcb:	e9 e6 fa ff ff       	jmp    801058b6 <alltraps>
...
80105dd2:	6a 03                	push   $0x3
  jmp alltraps
80105dd4:	e9 dd fa ff ff       	jmp    801058b6 <alltraps>
...
80105ddb:	6a 04                	push   $0x4
  jmp alltraps
80105ddd:	e9 d4 fa ff ff       	jmp    801058b6 <alltraps>
...
80105de4:	6a 05                	push   $0x5
  jmp alltraps
80105de6:	e9 cb fa ff ff       	jmp    801058b6 <alltraps>
...
80105ded:	6a 06                	push   $0x6
  jmp alltraps
80105def:	e9 c2 fa ff ff       	jmp    801058b6 <alltraps>
...
80105df6:	6a 07                	push   $0x7
  jmp alltraps
80105df8:	e9 b9 fa ff ff       	jmp    801058b6 <alltraps>
...
80105dfd:	6a 08                	push   $0x8
  jmp alltraps
80105dff:	e9 b2 fa ff ff       	jmp    801058b6 <alltraps>
...
80105e06:	6a 09                	push   $0x9
  jmp alltraps
80105e08:	e9 a9 fa ff ff       	jmp    801058b6 <alltraps>
...
80105e0d:	6a 0a                	push   $0xa
  jmp alltraps
80105e0f:	e9 a2 fa ff ff       	jmp    801058b6 <alltraps>
...
80105e14:	6a 0b                	push   $0xb
  jmp alltraps
80105e16:	e9 9b fa ff ff       	jmp    801058b6 <alltraps>
...
80105e1b:	6a 0c                	push   $0xc
  jmp alltraps
80105e1d:	e9 94 fa ff ff       	jmp    801058b6 <alltraps>
...
80105e22:	6a 0d                	push   $0xd
  jmp alltraps
80105e24:	e9 8d fa ff ff       	jmp    801058b6 <alltraps>
...
80105e29:	6a 0e                	push   $0xe
  jmp alltraps
80105e2b:	e9 86 fa ff ff       	jmp    801058b6 <alltraps>
...
80105e32:	6a 0f                	push   $0xf
  jmp alltraps
80105e34:	e9 7d fa ff ff       	jmp    801058b6 <alltraps>
...
80105e3b:	6a 10                	push   $0x10
  jmp alltraps
80105e3d:	e9 74 fa ff ff       	jmp    801058b6 <alltraps>
...
80105e42:	6a 11                	push   $0x11
  jmp alltraps
80105e44:	e9 6d fa ff ff       	jmp    801058b6 <alltraps>
...
80105e4b:	6a 12                	push   $0x12
  jmp alltraps
80105e4d:	e9 64 fa ff ff       	jmp    801058b6 <alltraps>
...
80105e54:	6a 13                	push   $0x13
  jmp alltraps
80105e56:	e9 5b fa ff ff       	jmp    801058b6 <alltraps>
...
80105e5d:	6a 14                	push   $0x14
  jmp alltraps
80105e5f:	e9 52 fa ff ff       	jmp    801058b6 <alltraps>
...
80105e66:	6a 15                	push   $0x15
  jmp alltraps
80105e68:	e9 49 fa ff ff       	jmp    801058b6 <alltraps>
...
80105e6f:	6a 16                	push   $0x16
  jmp alltraps
80105e71:	e9 40 fa ff ff       	jmp    801058b6 <alltraps>
...
80105e78:	6a 17                	push   $0x17
  jmp alltraps
80105e7a:	e9 37 fa ff ff       	jmp    801058b6 <alltraps>
...
80105e81:	6a 18                	push   $0x18
  jmp alltraps
80105e83:	e9 2e fa ff ff       	jmp    801058b6 <alltraps>
...
80105e8a:	6a 19                	push   $0x19
  jmp alltraps
80105e8c:	e9 25 fa ff ff       	jmp    801058b6 <alltraps>
...
80105e93:	6a 1a                	push   $0x1a
  jmp alltraps
80105e95:	e9 1c fa ff ff       	jmp    801058b6 <alltraps>
...
80105e9c:	6a 1b                	push   $0x1b
  jmp alltraps
80105e9e:	e9 13 fa ff ff       	jmp    801058b6 <alltraps>
...
80105ea5:	6a 1c                	push   $0x1c
  jmp alltraps
80105ea7:	e9 0a fa ff ff       	jmp    801058b6 <alltraps>
...
80105eae:	6a 1d                	push   $0x1d
  jmp alltraps
80105eb0:	e9 01 fa ff ff       	jmp    801058b6 <alltraps>
...
80105eb7:	6a 1e                	push   $0x1e
  jmp alltraps
80105eb9:	e9 f8 f9 ff ff       	jmp    801058b6 <alltraps>
...
80105ec0:	6a 1f                	push   $0x1f
  jmp alltraps
80105ec2:	e9 ef f9 ff ff       	jmp    801058b6 <alltraps>
...
80105ec9:	6a 20                	push   $0x20
  jmp alltraps
80105ecb:	e9 e6 f9 ff ff       	jmp    801058b6 <alltraps>
...
80105ed2:	6a 21                	push   $0x21
  jmp alltraps
80105ed4:	e9 dd f9 ff ff       	jmp    801058b6 <alltraps>
...
80105edb:	6a 22                	push   $0x22
  jmp alltraps
80105edd:	e9 d4 f9 ff ff       	jmp    801058b6 <alltraps>
...
80105ee4:	6a 23                	push   $0x23
  jmp alltraps
80105ee6:	e9 cb f9 ff ff       	jmp    801058b6 <alltraps>
...
80105eed:	6a 24                	push   $0x24
  jmp alltraps
80105eef:	e9 c2 f9 ff ff       	jmp    801058b6 <alltraps>
...
80105ef6:	6a 25                	push   $0x25
  jmp alltraps
80105ef8:	e9 b9 f9 ff ff       	jmp    801058b6 <alltraps>
...
80105eff:	6a 26                	push   $0x26
  jmp alltraps
80105f01:	e9 b0 f9 ff ff       	jmp    801058b6 <alltraps>
...
80105f08:	6a 27                	push   $0x27
  jmp alltraps
80105f0a:	e9 a7 f9 ff ff       	jmp    801058b6 <alltraps>
...
80105f11:	6a 28                	push   $0x28
  jmp alltraps
80105f13:	e9 9e f9 ff ff       	jmp    801058b6 <alltraps>
...
80105f1a:	6a 29                	push   $0x29
  jmp alltraps
80105f1c:	e9 95 f9 ff ff       	jmp    801058b6 <alltraps>
...
80105f23:	6a 2a                	push   $0x2a
  jmp alltraps
80105f25:	e9 8c f9 ff ff       	jmp    801058b6 <alltraps>
...
80105f2c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f2e:	e9 83 f9 ff ff       	jmp    801058b6 <alltraps>
...
80105f35:	6a 2c                	push   $0x2c
  jmp alltraps
80105f37:	e9 7a f9 ff ff       	jmp    801058b6 <alltraps>
...
80105f3e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f40:	e9 71 f9 ff ff       	jmp    801058b6 <alltraps>
...
80105f47:	6a 2e                	push   $0x2e
  jmp alltraps
80105f49:	e9 68 f9 ff ff       	jmp    801058b6 <alltraps>
...
80105f50:	6a 2f                	push   $0x2f
  jmp alltraps
80105f52:	e9 5f f9 ff ff       	jmp    801058b6 <alltraps>
...
80105f59:	6a 30                	push   $0x30
  jmp alltraps
80105f5b:	e9 56 f9 ff ff       	jmp    801058b6 <alltraps>
...
80105f62:	6a 31                	push   $0x31
  jmp alltraps
80105f64:	e9 4d f9 ff ff       	jmp    801058b6 <alltraps>
...
80105f6b:	6a 32                	push   $0x32
  jmp alltraps
80105f6d:	e9 44 f9 ff ff       	jmp    801058b6 <alltraps>
...
80105f74:	6a 33                	push   $0x33
  jmp alltraps
80105f76:	e9 3b f9 ff ff       	jmp    801058b6 <alltraps>
...
80105f7d:	6a 34                	push   $0x34
  jmp alltraps
80105f7f:	e9 32 f9 ff ff       	jmp    801058b6 <alltraps>
...
80105f86:	6a 35                	push   $0x35
  jmp alltraps
80105f88:	e9 29 f9 ff ff       	jmp    801058b6 <alltraps>
...
80105f8f:	6a 36                	push   $0x36
  jmp alltraps
80105f91:	e9 20 f9 ff ff       	jmp    801058b6 <alltraps>
...
80105f98:	6a 37                	push   $0x37
  jmp alltraps
80105f9a:	e9 17 f9 ff ff       	jmp    801058b6 <alltraps>
...
80105fa1:	6a 38                	push   $0x38
  jmp alltraps
80105fa3:	e9 0e f9 ff ff       	jmp    801058b6 <alltraps>
...
80105faa:	6a 39                	push   $0x39
  jmp alltraps
80105fac:	e9 05 f9 ff ff       	jmp    801058b6 <alltraps>
...
80105fb3:	6a 3a                	push   $0x3a
  jmp alltraps
80105fb5:	e9 fc f8 ff ff       	jmp    801058b6 <alltraps>
...
80105fbc:	6a 3b                	push   $0x3b
  jmp alltraps
80105fbe:	e9 f3 f8 ff ff       	jmp    801058b6 <alltraps>
...
80105fc5:	6a 3c                	push   $0x3c
  jmp alltraps
80105fc7:	e9 ea f8 ff ff       	jmp    801058b6 <alltraps>
...
80105fce:	6a 3d                	push   $0x3d
  jmp alltraps
80105fd0:	e9 e1 f8 ff ff       	jmp    801058b6 <alltraps>
...
80105fd7:	6a 3e                	push   $0x3e
  jmp alltraps
80105fd9:	e9 d8 f8 ff ff       	jmp    801058b6 <alltraps>
...
80105fe0:	6a 3f                	push   $0x3f
  jmp alltraps
80105fe2:	e9 cf f8 ff ff       	jmp    801058b6 <alltraps>
...
80105fe9:	6a 40                	push   $0x40
  jmp alltraps
80105feb:	e9 c6 f8 ff ff       	jmp    801058b6 <alltraps>
...
80105ff2:	6a 41                	push   $0x41
  jmp alltraps
80105ff4:	e9 bd f8 ff ff       	jmp    801058b6 <alltraps>
...
80105ffb:	6a 42                	push   $0x42
  jmp alltraps
80105ffd:	e9 b4 f8 ff ff       	jmp    801058b6 <alltraps>
...
80106004:	6a 43                	push   $0x43
  jmp alltraps
80106006:	e9 ab f8 ff ff       	jmp    801058b6 <alltraps>
...
8010600d:	6a 44                	push   $0x44
  jmp alltraps
8010600f:	e9 a2 f8 ff ff       	jmp    801058b6 <alltraps>
...
80106016:	6a 45                	push   $0x45
  jmp alltraps
80106018:	e9 99 f8 ff ff       	jmp    801058b6 <alltraps>
...
8010601f:	6a 46                	push   $0x46
  jmp alltraps
80106021:	e9 90 f8 ff ff       	jmp    801058b6 <alltraps>
...
80106028:	6a 47                	push   $0x47
  jmp alltraps
8010602a:	e9 87 f8 ff ff       	jmp    801058b6 <alltraps>
...
80106031:	6a 48                	push   $0x48
  jmp alltraps
80106033:	e9 7e f8 ff ff       	jmp    801058b6 <alltraps>
...
8010603a:	6a 49                	push   $0x49
  jmp alltraps
8010603c:	e9 75 f8 ff ff       	jmp    801058b6 <alltraps>
...
80106043:	6a 4a                	push   $0x4a
  jmp alltraps
80106045:	e9 6c f8 ff ff       	jmp    801058b6 <alltraps>
...
8010604c:	6a 4b                	push   $0x4b
  jmp alltraps
8010604e:	e9 63 f8 ff ff       	jmp    801058b6 <alltraps>
...
80106055:	6a 4c                	push   $0x4c
  jmp alltraps
80106057:	e9 5a f8 ff ff       	jmp    801058b6 <alltraps>
...
8010605e:	6a 4d                	push   $0x4d
  jmp alltraps
80106060:	e9 51 f8 ff ff       	jmp    801058b6 <alltraps>
...
80106067:	6a 4e                	push   $0x4e
  jmp alltraps
80106069:	e9 48 f8 ff ff       	jmp    801058b6 <alltraps>
...
80106070:	6a 4f                	push   $0x4f
  jmp alltraps
80106072:	e9 3f f8 ff ff       	jmp    801058b6 <alltraps>
...
80106079:	6a 50                	push   $0x50
  jmp alltraps
8010607b:	e9 36 f8 ff ff       	jmp    801058b6 <alltraps>
...
80106082:	6a 51                	push   $0x51
  jmp alltraps
80106084:	e9 2d f8 ff ff       	jmp    801058b6 <alltraps>
...
8010608b:	6a 52                	push   $0x52
  jmp alltraps
8010608d:	e9 24 f8 ff ff       	jmp    801058b6 <alltraps>
...
80106094:	6a 53                	push   $0x53
  jmp alltraps
80106096:	e9 1b f8 ff ff       	jmp    801058b6 <alltraps>
...
8010609d:	6a 54                	push   $0x54
  jmp alltraps
8010609f:	e9 12 f8 ff ff       	jmp    801058b6 <alltraps>
...
801060a6:	6a 55                	push   $0x55
  jmp alltraps
801060a8:	e9 09 f8 ff ff       	jmp    801058b6 <alltraps>
...
801060af:	6a 56                	push   $0x56
  jmp alltraps
801060b1:	e9 00 f8 ff ff       	jmp    801058b6 <alltraps>
...
801060b8:	6a 57                	push   $0x57
  jmp alltraps
801060ba:	e9 f7 f7 ff ff       	jmp    801058b6 <alltraps>
...
801060c1:	6a 58                	push   $0x58
  jmp alltraps
801060c3:	e9 ee f7 ff ff       	jmp    801058b6 <alltraps>
...
801060ca:	6a 59                	push   $0x59
  jmp alltraps
801060cc:	e9 e5 f7 ff ff       	jmp    801058b6 <alltraps>
...
801060d3:	6a 5a                	push   $0x5a
  jmp alltraps
801060d5:	e9 dc f7 ff ff       	jmp    801058b6 <alltraps>
...
801060dc:	6a 5b                	push   $0x5b
  jmp alltraps
801060de:	e9 d3 f7 ff ff       	jmp    801058b6 <alltraps>
...
801060e5:	6a 5c                	push   $0x5c
  jmp alltraps
801060e7:	e9 ca f7 ff ff       	jmp    801058b6 <alltraps>
...
801060ee:	6a 5d                	push   $0x5d
  jmp alltraps
801060f0:	e9 c1 f7 ff ff       	jmp    801058b6 <alltraps>
...
801060f7:	6a 5e                	push   $0x5e
  jmp alltraps
801060f9:	e9 b8 f7 ff ff       	jmp    801058b6 <alltraps>
...
80106100:	6a 5f                	push   $0x5f
  jmp alltraps
80106102:	e9 af f7 ff ff       	jmp    801058b6 <alltraps>
...
80106109:	6a 60                	push   $0x60
  jmp alltraps
8010610b:	e9 a6 f7 ff ff       	jmp    801058b6 <alltraps>
...
80106112:	6a 61                	push   $0x61
  jmp alltraps
80106114:	e9 9d f7 ff ff       	jmp    801058b6 <alltraps>
...
8010611b:	6a 62                	push   $0x62
  jmp alltraps
8010611d:	e9 94 f7 ff ff       	jmp    801058b6 <alltraps>
...
80106124:	6a 63                	push   $0x63
  jmp alltraps
80106126:	e9 8b f7 ff ff       	jmp    801058b6 <alltraps>
...
8010612d:	6a 64                	push   $0x64
  jmp alltraps
8010612f:	e9 82 f7 ff ff       	jmp    801058b6 <alltraps>
...
80106136:	6a 65                	push   $0x65
  jmp alltraps
80106138:	e9 79 f7 ff ff       	jmp    801058b6 <alltraps>
...
8010613f:	6a 66                	push   $0x66
  jmp alltraps
80106141:	e9 70 f7 ff ff       	jmp    801058b6 <alltraps>
...
80106148:	6a 67                	push   $0x67
  jmp alltraps
8010614a:	e9 67 f7 ff ff       	jmp    801058b6 <alltraps>
...
80106151:	6a 68                	push   $0x68
  jmp alltraps
80106153:	e9 5e f7 ff ff       	jmp    801058b6 <alltraps>
...
8010615a:	6a 69                	push   $0x69
  jmp alltraps
8010615c:	e9 55 f7 ff ff       	jmp    801058b6 <alltraps>
...
80106163:	6a 6a                	push   $0x6a
  jmp alltraps
80106165:	e9 4c f7 ff ff       	jmp    801058b6 <alltraps>
...
8010616c:	6a 6b                	push   $0x6b
  jmp alltraps
8010616e:	e9 43 f7 ff ff       	jmp    801058b6 <alltraps>
...
80106175:	6a 6c                	push   $0x6c
  jmp alltraps
80106177:	e9 3a f7 ff ff       	jmp    801058b6 <alltraps>
...
8010617e:	6a 6d                	push   $0x6d
  jmp alltraps
80106180:	e9 31 f7 ff ff       	jmp    801058b6 <alltraps>
...
80106187:	6a 6e                	push   $0x6e
  jmp alltraps
80106189:	e9 28 f7 ff ff       	jmp    801058b6 <alltraps>
...
80106190:	6a 6f                	push   $0x6f
  jmp alltraps
80106192:	e9 1f f7 ff ff       	jmp    801058b6 <alltraps>
...
80106199:	6a 70                	push   $0x70
  jmp alltraps
8010619b:	e9 16 f7 ff ff       	jmp    801058b6 <alltraps>
...
801061a2:	6a 71                	push   $0x71
  jmp alltraps
801061a4:	e9 0d f7 ff ff       	jmp    801058b6 <alltraps>
...
801061ab:	6a 72                	push   $0x72
  jmp alltraps
801061ad:	e9 04 f7 ff ff       	jmp    801058b6 <alltraps>
...
801061b4:	6a 73                	push   $0x73
  jmp alltraps
801061b6:	e9 fb f6 ff ff       	jmp    801058b6 <alltraps>
...
801061bd:	6a 74                	push   $0x74
  jmp alltraps
801061bf:	e9 f2 f6 ff ff       	jmp    801058b6 <alltraps>
...
801061c6:	6a 75                	push   $0x75
  jmp alltraps
801061c8:	e9 e9 f6 ff ff       	jmp    801058b6 <alltraps>
...
801061cf:	6a 76                	push   $0x76
  jmp alltraps
801061d1:	e9 e0 f6 ff ff       	jmp    801058b6 <alltraps>
...
801061d8:	6a 77                	push   $0x77
  jmp alltraps
801061da:	e9 d7 f6 ff ff       	jmp    801058b6 <alltraps>
...
801061e1:	6a 78                	push   $0x78
  jmp alltraps
801061e3:	e9 ce f6 ff ff       	jmp    801058b6 <alltraps>
...
801061ea:	6a 79                	push   $0x79
  jmp alltraps
801061ec:	e9 c5 f6 ff ff       	jmp    801058b6 <alltraps>
...
801061f3:	6a 7a                	push   $0x7a
  jmp alltraps
801061f5:	e9 bc f6 ff ff       	jmp    801058b6 <alltraps>
...
801061fc:	6a 7b                	push   $0x7b
  jmp alltraps
801061fe:	e9 b3 f6 ff ff       	jmp    801058b6 <alltraps>
...
80106205:	6a 7c                	push   $0x7c
  jmp alltraps
80106207:	e9 aa f6 ff ff       	jmp    801058b6 <alltraps>
...
8010620e:	6a 7d                	push   $0x7d
  jmp alltraps
80106210:	e9 a1 f6 ff ff       	jmp    801058b6 <alltraps>
...
80106217:	6a 7e                	push   $0x7e
  jmp alltraps
80106219:	e9 98 f6 ff ff       	jmp    801058b6 <alltraps>
...
80106220:	6a 7f                	push   $0x7f
  jmp alltraps
80106222:	e9 8f f6 ff ff       	jmp    801058b6 <alltraps>
...
80106229:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010622e:	e9 83 f6 ff ff       	jmp    801058b6 <alltraps>
...
80106235:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010623a:	e9 77 f6 ff ff       	jmp    801058b6 <alltraps>
...
80106241:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106246:	e9 6b f6 ff ff       	jmp    801058b6 <alltraps>
...
8010624d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106252:	e9 5f f6 ff ff       	jmp    801058b6 <alltraps>
...
80106259:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010625e:	e9 53 f6 ff ff       	jmp    801058b6 <alltraps>
...
80106265:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010626a:	e9 47 f6 ff ff       	jmp    801058b6 <alltraps>
...
80106271:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106276:	e9 3b f6 ff ff       	jmp    801058b6 <alltraps>
...
8010627d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106282:	e9 2f f6 ff ff       	jmp    801058b6 <alltraps>
...
80106289:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010628e:	e9 23 f6 ff ff       	jmp    801058b6 <alltraps>
...
80106295:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010629a:	e9 17 f6 ff ff       	jmp    801058b6 <alltraps>
...
801062a1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801062a6:	e9 0b f6 ff ff       	jmp    801058b6 <alltraps>
...
801062ad:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801062b2:	e9 ff f5 ff ff       	jmp    801058b6 <alltraps>
...
801062b9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801062be:	e9 f3 f5 ff ff       	jmp    801058b6 <alltraps>
...
801062c5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801062ca:	e9 e7 f5 ff ff       	jmp    801058b6 <alltraps>
...
801062d1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801062d6:	e9 db f5 ff ff       	jmp    801058b6 <alltraps>
...
801062dd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801062e2:	e9 cf f5 ff ff       	jmp    801058b6 <alltraps>
...
801062e9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801062ee:	e9 c3 f5 ff ff       	jmp    801058b6 <alltraps>
...
801062f5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801062fa:	e9 b7 f5 ff ff       	jmp    801058b6 <alltraps>
...
80106301:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106306:	e9 ab f5 ff ff       	jmp    801058b6 <alltraps>
...
8010630d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106312:	e9 9f f5 ff ff       	jmp    801058b6 <alltraps>
...
80106319:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010631e:	e9 93 f5 ff ff       	jmp    801058b6 <alltraps>
...
80106325:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010632a:	e9 87 f5 ff ff       	jmp    801058b6 <alltraps>
...
80106331:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106336:	e9 7b f5 ff ff       	jmp    801058b6 <alltraps>
...
8010633d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106342:	e9 6f f5 ff ff       	jmp    801058b6 <alltraps>
...
80106349:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010634e:	e9 63 f5 ff ff       	jmp    801058b6 <alltraps>
...
80106355:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010635a:	e9 57 f5 ff ff       	jmp    801058b6 <alltraps>
...
80106361:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106366:	e9 4b f5 ff ff       	jmp    801058b6 <alltraps>
...
8010636d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106372:	e9 3f f5 ff ff       	jmp    801058b6 <alltraps>
...
80106379:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010637e:	e9 33 f5 ff ff       	jmp    801058b6 <alltraps>
...
80106385:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010638a:	e9 27 f5 ff ff       	jmp    801058b6 <alltraps>
...
80106391:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106396:	e9 1b f5 ff ff       	jmp    801058b6 <alltraps>
...
8010639d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801063a2:	e9 0f f5 ff ff       	jmp    801058b6 <alltraps>
...
801063a9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801063ae:	e9 03 f5 ff ff       	jmp    801058b6 <alltraps>
...
801063b5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801063ba:	e9 f7 f4 ff ff       	jmp    801058b6 <alltraps>
...
801063c1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801063c6:	e9 eb f4 ff ff       	jmp    801058b6 <alltraps>
...
801063cd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801063d2:	e9 df f4 ff ff       	jmp    801058b6 <alltraps>
...
801063d9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801063de:	e9 d3 f4 ff ff       	jmp    801058b6 <alltraps>
...
801063e5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801063ea:	e9 c7 f4 ff ff       	jmp    801058b6 <alltraps>
...
801063f1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801063f6:	e9 bb f4 ff ff       	jmp    801058b6 <alltraps>
...
801063fd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106402:	e9 af f4 ff ff       	jmp    801058b6 <alltraps>
...
80106409:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010640e:	e9 a3 f4 ff ff       	jmp    801058b6 <alltraps>
...
80106415:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010641a:	e9 97 f4 ff ff       	jmp    801058b6 <alltraps>
...
80106421:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106426:	e9 8b f4 ff ff       	jmp    801058b6 <alltraps>
...
8010642d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106432:	e9 7f f4 ff ff       	jmp    801058b6 <alltraps>
...
80106439:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010643e:	e9 73 f4 ff ff       	jmp    801058b6 <alltraps>
...
80106445:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010644a:	e9 67 f4 ff ff       	jmp    801058b6 <alltraps>
...
80106451:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106456:	e9 5b f4 ff ff       	jmp    801058b6 <alltraps>
...
8010645d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106462:	e9 4f f4 ff ff       	jmp    801058b6 <alltraps>
...
80106469:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010646e:	e9 43 f4 ff ff       	jmp    801058b6 <alltraps>
...
80106475:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010647a:	e9 37 f4 ff ff       	jmp    801058b6 <alltraps>
...
80106481:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106486:	e9 2b f4 ff ff       	jmp    801058b6 <alltraps>
...
8010648d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106492:	e9 1f f4 ff ff       	jmp    801058b6 <alltraps>
...
80106499:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010649e:	e9 13 f4 ff ff       	jmp    801058b6 <alltraps>
...
801064a5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801064aa:	e9 07 f4 ff ff       	jmp    801058b6 <alltraps>
...
801064b1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801064b6:	e9 fb f3 ff ff       	jmp    801058b6 <alltraps>
...
801064bd:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801064c2:	e9 ef f3 ff ff       	jmp    801058b6 <alltraps>
...
801064c9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801064ce:	e9 e3 f3 ff ff       	jmp    801058b6 <alltraps>
...
801064d5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801064da:	e9 d7 f3 ff ff       	jmp    801058b6 <alltraps>
...
801064e1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801064e6:	e9 cb f3 ff ff       	jmp    801058b6 <alltraps>
...
801064ed:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801064f2:	e9 bf f3 ff ff       	jmp    801058b6 <alltraps>
...
801064f9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801064fe:	e9 b3 f3 ff ff       	jmp    801058b6 <alltraps>
...
80106505:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010650a:	e9 a7 f3 ff ff       	jmp    801058b6 <alltraps>
...
80106511:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106516:	e9 9b f3 ff ff       	jmp    801058b6 <alltraps>
...
8010651d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106522:	e9 8f f3 ff ff       	jmp    801058b6 <alltraps>
...
80106529:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010652e:	e9 83 f3 ff ff       	jmp    801058b6 <alltraps>
...
80106535:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010653a:	e9 77 f3 ff ff       	jmp    801058b6 <alltraps>
...
80106541:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106546:	e9 6b f3 ff ff       	jmp    801058b6 <alltraps>
...
8010654d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106552:	e9 5f f3 ff ff       	jmp    801058b6 <alltraps>
...
80106559:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010655e:	e9 53 f3 ff ff       	jmp    801058b6 <alltraps>
...
80106565:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010656a:	e9 47 f3 ff ff       	jmp    801058b6 <alltraps>
...
80106571:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106576:	e9 3b f3 ff ff       	jmp    801058b6 <alltraps>
...
8010657d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106582:	e9 2f f3 ff ff       	jmp    801058b6 <alltraps>
...
80106589:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010658e:	e9 23 f3 ff ff       	jmp    801058b6 <alltraps>
...
80106595:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010659a:	e9 17 f3 ff ff       	jmp    801058b6 <alltraps>
...
801065a1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801065a6:	e9 0b f3 ff ff       	jmp    801058b6 <alltraps>
...
801065ad:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801065b2:	e9 ff f2 ff ff       	jmp    801058b6 <alltraps>
...
801065b9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801065be:	e9 f3 f2 ff ff       	jmp    801058b6 <alltraps>
...
801065c5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801065ca:	e9 e7 f2 ff ff       	jmp    801058b6 <alltraps>
...
801065d1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801065d6:	e9 db f2 ff ff       	jmp    801058b6 <alltraps>
...
801065dd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801065e2:	e9 cf f2 ff ff       	jmp    801058b6 <alltraps>
...
801065e9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801065ee:	e9 c3 f2 ff ff       	jmp    801058b6 <alltraps>
...
801065f5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801065fa:	e9 b7 f2 ff ff       	jmp    801058b6 <alltraps>
...
80106601:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106606:	e9 ab f2 ff ff       	jmp    801058b6 <alltraps>
...
8010660d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106612:	e9 9f f2 ff ff       	jmp    801058b6 <alltraps>
...
80106619:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010661e:	e9 93 f2 ff ff       	jmp    801058b6 <alltraps>
...
80106625:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010662a:	e9 87 f2 ff ff       	jmp    801058b6 <alltraps>
...
80106631:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106636:	e9 7b f2 ff ff       	jmp    801058b6 <alltraps>
...
8010663d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106642:	e9 6f f2 ff ff       	jmp    801058b6 <alltraps>
...
80106649:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010664e:	e9 63 f2 ff ff       	jmp    801058b6 <alltraps>
...
80106655:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010665a:	e9 57 f2 ff ff       	jmp    801058b6 <alltraps>
...
80106661:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106666:	e9 4b f2 ff ff       	jmp    801058b6 <alltraps>
...
8010666d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106672:	e9 3f f2 ff ff       	jmp    801058b6 <alltraps>
...
80106679:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010667e:	e9 33 f2 ff ff       	jmp    801058b6 <alltraps>
...
80106685:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010668a:	e9 27 f2 ff ff       	jmp    801058b6 <alltraps>
...
80106691:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106696:	e9 1b f2 ff ff       	jmp    801058b6 <alltraps>
...
8010669d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801066a2:	e9 0f f2 ff ff       	jmp    801058b6 <alltraps>
...
801066a9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801066ae:	e9 03 f2 ff ff       	jmp    801058b6 <alltraps>
...
801066b5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801066ba:	e9 f7 f1 ff ff       	jmp    801058b6 <alltraps>
...
801066c1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801066c6:	e9 eb f1 ff ff       	jmp    801058b6 <alltraps>
...
801066cd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801066d2:	e9 df f1 ff ff       	jmp    801058b6 <alltraps>
...
801066d9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801066de:	e9 d3 f1 ff ff       	jmp    801058b6 <alltraps>
...
801066e5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801066ea:	e9 c7 f1 ff ff       	jmp    801058b6 <alltraps>
...
801066f1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801066f6:	e9 bb f1 ff ff       	jmp    801058b6 <alltraps>
...
801066fd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106702:	e9 af f1 ff ff       	jmp    801058b6 <alltraps>
...
80106709:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010670e:	e9 a3 f1 ff ff       	jmp    801058b6 <alltraps>
...
80106715:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010671a:	e9 97 f1 ff ff       	jmp    801058b6 <alltraps>
...
80106721:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106726:	e9 8b f1 ff ff       	jmp    801058b6 <alltraps>
...
8010672d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106732:	e9 7f f1 ff ff       	jmp    801058b6 <alltraps>
...
80106739:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010673e:	e9 73 f1 ff ff       	jmp    801058b6 <alltraps>
...
80106745:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010674a:	e9 67 f1 ff ff       	jmp    801058b6 <alltraps>
...
80106751:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106756:	e9 5b f1 ff ff       	jmp    801058b6 <alltraps>
...
8010675d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106762:	e9 4f f1 ff ff       	jmp    801058b6 <alltraps>
...
80106769:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010676e:	e9 43 f1 ff ff       	jmp    801058b6 <alltraps>
...
80106775:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010677a:	e9 37 f1 ff ff       	jmp    801058b6 <alltraps>
...
80106781:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106786:	e9 2b f1 ff ff       	jmp    801058b6 <alltraps>
...
8010678d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106792:	e9 1f f1 ff ff       	jmp    801058b6 <alltraps>
...
80106799:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010679e:	e9 13 f1 ff ff       	jmp    801058b6 <alltraps>
...
801067a5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801067aa:	e9 07 f1 ff ff       	jmp    801058b6 <alltraps>
...
801067b1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801067b6:	e9 fb f0 ff ff       	jmp    801058b6 <alltraps>
...
801067bd:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801067c2:	e9 ef f0 ff ff       	jmp    801058b6 <alltraps>
...
801067c9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801067ce:	e9 e3 f0 ff ff       	jmp    801058b6 <alltraps>
...
801067d5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801067da:	e9 d7 f0 ff ff       	jmp    801058b6 <alltraps>
...
801067e1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801067e6:	e9 cb f0 ff ff       	jmp    801058b6 <alltraps>
...
801067ed:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801067f2:	e9 bf f0 ff ff       	jmp    801058b6 <alltraps>
...
801067f9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801067fe:	e9 b3 f0 ff ff       	jmp    801058b6 <alltraps>
...
80106805:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010680a:	e9 a7 f0 ff ff       	jmp    801058b6 <alltraps>
...
80106811:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106816:	e9 9b f0 ff ff       	jmp    801058b6 <alltraps>
...
8010681d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106822:	e9 8f f0 ff ff       	jmp    801058b6 <alltraps>
...
801068cb:	e8 70 bc ff ff       	call   80102540 <kfree>
      *pte = 0;
...
80106970:	e8 8b bd ff ff       	call   80102700 <kalloc>
...
801069e3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801069e6:	e8 05 d0 ff ff       	call   801039f0 <cpuid>
  pd[0] = size-1;
...
80106aaf:	e8 dc ce ff ff       	call   80103990 <mycpu>
80106ab4:	89 c3                	mov    %eax,%ebx
80106ab6:	e8 d5 ce ff ff       	call   80103990 <mycpu>
80106abb:	89 c7                	mov    %eax,%edi
80106abd:	e8 ce ce ff ff       	call   80103990 <mycpu>
80106ac2:	83 c7 08             	add    $0x8,%edi
80106ac5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106ac8:	e8 c3 ce ff ff       	call   80103990 <mycpu>
...
80106b11:	e8 7a ce ff ff       	call   80103990 <mycpu>
80106b16:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106b1d:	e8 6e ce ff ff       	call   80103990 <mycpu>
...
80106b34:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106b37:	e8 54 ce ff ff       	call   80103990 <mycpu>
...
80106b59:	5d                   	pop    %ebp
  popcli();
80106b5a:	e9 f1 da ff ff       	jmp    80104650 <popcli>
...
80106bab:	77 49                	ja     80106bf6 <inituvm+0x66>
  mem = kalloc();
80106bad:	e8 4e bb ff ff       	call   80102700 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106c96:	e8 65 ae ff ff       	call   80101b00 <readi>
...
80106d59:	0f 83 89 00 00 00    	jae    80106de8 <allocuvm+0x108>
    mem = kalloc();
80106d5f:	e8 9c b9 ff ff       	call   80102700 <kalloc>
...
80106dd6:	e8 65 b7 ff ff       	call   80102540 <kfree>
      return 0;
...
80106e7e:	e8 bd b6 ff ff       	call   80102540 <kfree>
...
80106e93:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106e94:	e9 a7 b6 ff ff       	jmp    80102540 <kfree>
    panic("freevm: no pgdir");
...
80106eb5:	e8 46 b8 ff ff       	call   80102700 <kalloc>
...
80106fb3:	0f 84 dd 00 00 00    	je     80107096 <copyuvm+0xf6>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106fb9:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106fbc:	85 c9                	test   %ecx,%ecx
80106fbe:	0f 84 b3 00 00 00    	je     80107077 <copyuvm+0xd7>
...
80107009:	74 d4                	je     80106fdf <copyuvm+0x3f>
    if(!(*pte & PTE_P))
8010700b:	8b 18                	mov    (%eax),%ebx
8010700d:	f6 c3 01             	test   $0x1,%bl
80107010:	0f 84 92 00 00 00    	je     801070a8 <copyuvm+0x108>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80107016:	89 df                	mov    %ebx,%edi
    flags = PTE_FLAGS(*pte);
80107018:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
    pa = PTE_ADDR(*pte);
8010701e:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107024:	e8 d7 b6 ff ff       	call   80102700 <kalloc>
80107029:	85 c0                	test   %eax,%eax
8010702b:	74 5b                	je     80107088 <copyuvm+0xe8>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
8010702d:	83 ec 04             	sub    $0x4,%esp
80107030:	81 c7 00 00 00 80    	add    $0x80000000,%edi
80107036:	68 00 10 00 00       	push   $0x1000
...
80107045:	58                   	pop    %eax
80107046:	5a                   	pop    %edx
80107047:	53                   	push   %ebx
80107048:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010704b:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107050:	81 c2 00 00 00 80    	add    $0x80000000,%edx
80107056:	52                   	push   %edx
80107057:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010705a:	89 f2                	mov    %esi,%edx
8010705c:	e8 8f f8 ff ff       	call   801068f0 <mappages>
80107061:	83 c4 10             	add    $0x10,%esp
80107064:	85 c0                	test   %eax,%eax
80107066:	78 20                	js     80107088 <copyuvm+0xe8>
  for(i = 0; i < sz; i += PGSIZE){
80107068:	81 c6 00 10 00 00    	add    $0x1000,%esi
8010706e:	3b 75 0c             	cmp    0xc(%ebp),%esi
80107071:	0f 82 59 ff ff ff    	jb     80106fd0 <copyuvm+0x30>
  return d;
...
8010708b:	ff 75 e0             	push   -0x20(%ebp)
8010708e:	e8 9d fd ff ff       	call   80106e30 <freevm>
  return 0;
80107093:	83 c4 10             	add    $0x10,%esp
    return 0;
80107096:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
}
...
801070ab:	68 92 7b 10 80       	push   $0x80107b92
...
801070d4:	0f 84 00 01 00 00    	je     801071da <uva2ka.cold>
  return &pgtab[PTX(va)];
...
801070e4:	25 ff 03 00 00       	and    $0x3ff,%eax
  if((*pte & PTE_P) == 0)
801070e9:	8b 84 82 00 00 00 80 	mov    -0x80000000(%edx,%eax,4),%eax
  if((*pte & PTE_U) == 0)
...
801070f7:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
801070fa:	05 00 00 00 80       	add    $0x80000000,%eax
801070ff:	83 fa 05             	cmp    $0x5,%edx
80107102:	ba 00 00 00 00       	mov    $0x0,%edx
80107107:	0f 45 c2             	cmovne %edx,%eax
}
8010710a:	c3                   	ret
...
80107126:	e9 a5 00 00 00       	jmp    801071d0 <copyout+0xc0>
...
80107142:	74 75                	je     801071b9 <copyout+0xa9>
      return -1;
    n = PGSIZE - (va - va0);
...
80107160:	e8 2b d6 ff ff       	call   80104790 <memmove>
    len -= n;
    buf += n;
...
80107175:	74 59                	je     801071d0 <copyout+0xc0>
  if(*pde & PTE_P){
...
8010718d:	0f 84 4e 00 00 00    	je     801071e1 <copyout.cold>
  return &pgtab[PTX(va)];
...
801071ad:	83 e1 05             	and    $0x5,%ecx
801071b0:	83 f9 05             	cmp    $0x5,%ecx
801071b3:	0f 84 77 ff ff ff    	je     80107130 <copyout+0x20>
  }
  return 0;
}
...
801071da <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
801071da:	a1 00 00 00 00       	mov    0x0,%eax
801071df:	0f 0b                	ud2

801071e1 <copyout.cold>:
801071e1:	a1 00 00 00 00       	mov    0x0,%eax
801071e6:	0f 0b                	ud2

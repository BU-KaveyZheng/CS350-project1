  ...
  11:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  37:	e8 b4 03 00 00       	call   3f0 <printf>
        exit();
  3c:	e8 62 02 00 00       	call   2a3 <exit>
  41:	66 90                	xchg   %ax,%ax
  43:	66 90                	xchg   %ax,%ax
  45:	66 90                	xchg   %ax,%ax
  47:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
 ...
 5a1:	a1 74 0a 00 00       	mov    0xa74,%eax
{
 ...
 5e1:	5b                   	pop    %ebx
  freep = p;
 5e2:	89 15 74 0a 00 00    	mov    %edx,0xa74
}
 5e8:	5e                   	pop    %esi
 5e9:	5f                   	pop    %edi
 5ea:	5d                   	pop    %ebp
 ...
 617:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 61a:	89 15 74 0a 00 00    	mov    %edx,0xa74
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 15 74 0a 00 00    	mov    0xa74,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67b:	39 05 74 0a 00 00    	cmp    %eax,0xa74
 ...
 69e:	e8 fd fe ff ff       	call   5a0 <free>
  return freep;
 6a3:	8b 15 74 0a 00 00    	mov    0xa74,%edx
 ...
 6cc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6cf:	89 15 74 0a 00 00    	mov    %edx,0xa74
}
 ...
 6df:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6e0:	c7 05 74 0a 00 00 78 	movl   $0xa78,0xa74
 6e7:	0a 00 00 
    base.s.size = 0;
 6ea:	b8 78 0a 00 00       	mov    $0xa78,%eax
    base.s.ptr = freep = prevp = &base;
 6ef:	c7 05 78 0a 00 00 78 	movl   $0xa78,0xa78
 6f6:	0a 00 00 
    base.s.size = 0;
 6f9:	c7 05 7c 0a 00 00 00 	movl   $0x0,0xa7c
 700:	00 00 00 
    if(p->s.size >= nunits){
